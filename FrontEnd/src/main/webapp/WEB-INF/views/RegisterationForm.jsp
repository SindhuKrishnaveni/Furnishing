...
$(document).ready(function(){
	$('#form').validate({
		...
		messages:{
			...
			"user.emailid":{required:"Email is required",email:"Please enter valid email address"}
		}
	})
})
...
<div class="container">
	...
	<form:label path="user.emailid">Enter Email</form:label>
	<form:input path="user.emailid" id="user.email" type="email"/>
